...
def main():
    ...
    # retriving max sequence length from user args and adding it to the data dictionary for future reference
    opt.max_token_seq_len = data['settings'].max_token_seq_len

    training_data, validation_data = prepare_dataloaders(data, opt)

    # Appending vocab sizes
